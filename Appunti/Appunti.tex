...
Uno dei moduli principali per Node.js è il modulo \textbf{HTTP} che fornisce un server Web e un client Web. Il \textbf{server Web} è molto flessibile, ma richiede molto codice boilerplate per costruire anche le applicazioni più semplici. I server Web sono applicazioni ad alta intensità I/O che li rendono adatti per Node.js, il quale è ottimo grazie
